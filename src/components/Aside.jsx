...
const Aside= ({chatOpen})=>{
    ...
    const [openInfoProfile, setopenInfoProfile]=  useState(false)
    ...
    const filterContacts = users.filter((contacto)=> {
        ...
        return(
        (contacto.firstName.toLowerCase().includes(search.toLowerCase()) || contacto.lastName.toLowerCase().includes(search.toLowerCase()) || fullname.toLocaleLowerCase().includes(search.toLocaleLowerCase()))) && !contacto.logged
    })
    ...
    return(
        <aside className={chatOpen ? "aside hide-mobile" : "aside"}>
            <div className="container-search">
                <div className="header-exit">
                    ...
                    <div className="container-settings-close">
                        ...
                        <button className="cerrar-sesion btn-aside" onClick={()=> setopenInfoProfile(true)}><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24"><path fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11v5m0 5a9 9 0 1 1 0-18a9 9 0 0 1 0 18m.05-13v.1h-.1V8z"/></svg></button>
                    </div>
                </div>
            ...
            {
                openInfoProfile && <Profile setOpenInfoProfile={setopenInfoProfile}/>
            }
        </aside>
    )
}
